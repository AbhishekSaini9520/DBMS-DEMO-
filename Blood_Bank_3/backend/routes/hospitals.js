...
const {  getAllHospitals,  getHospitalById,  getHospitalProfile,  createHospital,  updateHospital,  approveHospital,  deleteHospital,  getPendingHospitals,  getHospitalStats} = require('../controllers/hospitalController');
const {  validateHospitalRegistration} = require('../middleware/validation');
