...
const {  getAllRequests,  getRequestById,  getRequestsByPatient,  getRequestsByStatus,  createRequest,  updateRequestStatus,  updateRequest,  deleteRequest,  getPendingRequests,  getRequestStats} = require('../controllers/requestController');
