...
const {  getAllRequests,  getRequestById,  getRequestsByPatient,  getRequestsByStatus,  createRequest,  updateRequestStatus,  updateRequest, getPendingRequests,  getRequestStats} = require('../controllers/requestController');
